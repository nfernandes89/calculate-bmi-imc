function calculateIMC(event) {
  ...
  if (imc < 18.5) {
    document.querySelector(".semaforo").setAttribute("src", "attention.png");
    imcResult.setAttribute("class", "result-js");
    imcResult.innerHTML = imc + ": Underweight";
  } else if (imc > 18.5 && imc <= 24.9) {
    document.querySelector(".semaforo").setAttribute("src", "light-green.png");
    imcResult.setAttribute("class", "result-js");
    imcResult.innerHTML = imc + ": Normal weight";
  } else if (imc > 25 && imc <= 29.9) {
    document.querySelector(".semaforo").setAttribute("src", "light-yellow.png");
    imcResult.setAttribute("class", "result-js");
    imcResult.innerHTML = imc + ": Overweight";
  } else if (imc > 30) {
    document.querySelector(".semaforo").setAttribute("src", "light-red.png");
    imcResult.setAttribute("class", "result-js");
